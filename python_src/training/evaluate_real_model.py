"""Evaluate the trained real robot model and export predicted versus true actions."""
...
from python_src.training.train_real import RealRobotActionNet


def main() -> None:
    dataset = RealRobotDataset(PROJECT_ROOT / "data" / "pilot_dataset" / "episode_1")
    model_path = PROJECT_ROOT / "data" / "real_model.pth"
    predictions_path = PROJECT_ROOT / "data" / "real_model_predictions.csv"
